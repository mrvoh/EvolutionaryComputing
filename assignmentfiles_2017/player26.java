...
public class player26 implements ContestSubmission
{
    ...
    // Changeable params
	public int POP_SIZE = 400;
	public double SCALING_FACTOR = 0.5582452185663355;
	public double CROSSOVER_PROB = 0.9660489347248544;
   ...
   private double new_mutation_factor(List<Integer> candidates, double[] fitness_values,int evals) {
	...
	public void run()
	{   
        if (evaluations_limit_ == 10000){ // BentCigar
             // Changeable params
	        POP_SIZE = 25;
	        SCALING_FACTOR = 0.370334775100607;
	        CROSSOVER_PROB = 0.624892166341054;

            // Params for DE operators (different versions of algorithm)
	        NR_PERTURBATION_VECTORS = 1;
	        BASE_VECTOR = "rand";
	        CROSSOVER_SCHEME = "bin";
            NF_THRESHOLD = 0.0887756112970238;

        } else if ( evaluations_limit_ == 100000){ // Schaffers

             // Changeable params
	        POP_SIZE = 185;
	        SCALING_FACTOR = 0.169657634351319;
	        CROSSOVER_PROB = 0.8320866406;
        
            // Params for DE operators (different versions of algorithm)
	        NR_PERTURBATION_VECTORS = 3;
	        BASE_VECTOR = "rand";
	        CROSSOVER_SCHEME = "bin";
            NF_THRESHOLD = 0.9;
             ...
             // Changeable params
	        POP_SIZE = 450;
	        SCALING_FACTOR = 0.269859616714913;
	        CROSSOVER_PROB = 0.822142765678219;
        ...
        while(evals<evaluations_limit_){
            ...
            //     SCALING_FACTOR = SCALING_FACTOR*0.999;
            // }
